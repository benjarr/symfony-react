...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le prénom doit être entre 3 et 255 caractères")
     */
    private $firstName;
     ...
     * @Assert\Length(min=3, minMessage="Le nom de famille doit être entre 3 et 255 caractères")
     */
    private $lastName;
